  ...
  useEffect(() => {
    if (isAuthenticated && !isLoading) {
      toast.success("Account created successfully!", {
        description: "Welcome to turf-booked...",
      });
      setTimeout(() => {
        navigate("/turfs");
      }, 1500);
      ...
      <div className="container pt-24 pb-20">
        ...
        >
          <div className="bg-primary/5 px-6 py-6 border-b border-primary/10">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Join turf-booked today</p>
          </div>
          ...
          <div className="border-t border-border bg-primary/5 px-6 py-4 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/signin" className="font-semibold text-primary hover:text-primary/80 transition">
                Sign In
              </Link>
            </p>
          </div>
